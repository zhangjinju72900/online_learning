 ...
 *
 */
@Service("unrecommendCheckManagePlugin")
public class UnrecommendCheckManagePlugin implements ILogicPlugin {
	@Resource
	...
	private String sqlTemplate = "khAdmin/checkManage/UpdateCheckManageRecommend";
