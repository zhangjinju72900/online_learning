 ...
 *
 */
@Service("TopActivityManagePlugin")
public class TopActivityManagePlugin implements ILogicPlugin {
	@Resource
    FormLogService formLogService;
	@Resource
	private FormMapper formMapper;
	private String sqlTemplate = "khAdmin/activityManage/TopActivityManage";
