 ...
 *
 */
@Service("importStudentRolePlugin")
public class ImportStudentRolePlugin implements ILogicServicePlugin {
	@Resource
	...
	public void doAfter(FormEngineRequest requestObj, FormModel formModel, Object beforeResult) {
		...
		String className = map.get("className") == null ? "" : map.get("className").toString();
		...
		map1.put("name", className);
		map1.put("gradeName", gradeName);
