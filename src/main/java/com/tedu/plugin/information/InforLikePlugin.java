 ...
 *
 */
@Service("infoLikePlugin")
public class InforLikePlugin implements ILogicPlugin {
	@Resource
	...
	private String sqlTemplate = "khApp/discover/information/insertinfoLike";
	...
	public void doAfter(FormEngineRequest requestObj, FormModel formModel, Object beforeResult,
		...
		if(r == 1){
			formModel.getData().put("baseId", cModel.getPrimaryFieldValue());
			sendMsg.sendMsg(SendMsgTypeEnum.INFO_LIKE, formModel.getData());
		}
