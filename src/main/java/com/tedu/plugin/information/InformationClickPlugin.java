 ...
 *
 */
@Service("informationClick")
public class InformationClickPlugin implements ILogicPlugin {
	@Resource
    FormLogService formLogService;
	@Resource
	private FormMapper formMapper;
	private String sqlTemplate = "khApp/discover/information/insertInformationClick";
