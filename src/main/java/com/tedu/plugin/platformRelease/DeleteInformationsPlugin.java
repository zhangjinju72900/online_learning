 ...
 *
 */
@Service("deleteInformationsPlugin")
public class DeleteInformationsPlugin implements ILogicServicePlugin {
	@Resource
    FormLogService formLogService;
	@Resource
	private FormMapper formMapper;
	private String sqlTemplate = "informations/DeleteInformations";
