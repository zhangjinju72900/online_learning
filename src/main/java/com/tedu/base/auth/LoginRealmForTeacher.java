...
import com.tedu.common.constant.DefaultRoleEnum;
 ...
 * @author xijianguang
 */
public class LoginRealmForTeacher extends AuthorizingRealm {
...
//            }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
        ...
        try {
        	userModels = customLoginService.getTeacherInfoByName(token.getUsername());
        } catch (Exception e) {
