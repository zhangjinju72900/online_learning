...
(function (global) {
    ...
    global.onload = function () {
		...
		document.body.onkeydown = function (e) {
	        ...
	        if (code == 13) {    
	          	OnClick_pformDown_ctlSave_frmMaintainManualEdit();
	        }    
...
<body class="easyui-layout js-ui" title="编辑普通资料" id="frmMaintainManualEdit" style="width:100%;height:100%;background-color:white;">
...
<input type="hidden" id="uiid" value="b80695bbfd9e433d82fff026cf779085">
<input type="hidden" id="puid" value="b16525ce953b4d74a98f0883f606ae06">
<style>
...
<label class='js-label'style="width:10px;height:22px;text-align:left" width-data="1" id="addGroup_ctlName1" name="ctlName1"/>当前支持单个文件上传(mp4,swf,flv,pdf,docx,doc,xls,xlsx,ppt,pptx)</label>
</div> 	<br>
...
"
	...
	onClickButton:function(){eval('OnClick_addGroup_fileName_frmMaintainManualEdit()');},
...
<div style="float: left;line-height: 29px;" class="js-path"></div>
		...
		OnClick="OnClick_pformDown_ctlSave_frmMaintainManualEdit();antiClick('pformDown_ctlSave');" 
...
"
		...
		<a class="easyui-linkbutton" href="javascript:void(0)" 
		OnClick="OnClick_pformDown_ctlCancel_frmMaintainManualEdit();antiClick('pformDown_ctlCancel');" 
...
${js}
    ...
    function getPanelId(panelName) {
     ...
     function getEditMode(){
      return getUIMode('frmMaintainManualEdit');
     }
