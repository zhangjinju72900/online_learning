 ...
 *
 */
@Service("ActivityLikePlugin")
public class ActivityLikePlugin implements ILogicPlugin {
	@Resource
	FormLogService formLogService;
	@Resource
	private FormMapper formMapper;
	private String sqlTemplate = "khApp/discover/activity/insertActivityLike";
