 ...
 *
 */
@Service("infoPreviewPlugin")
public class InfoPreviewPlugin implements ILogicPlugin {
	@Resource
	...
	public void doAfter(FormEngineRequest requestObj, FormModel formModel, Object beforeResult, FormEngineResponse responseObj) {
		...
		try {
			...
			if(StringUtils.isBlank(previewFileId)){
				...
				QrCodeCreateUtil.createQrCode(new FileOutputStream(f),QrCodeCreateUtil.infoPreviewUrl+id,900,"JPEG");
