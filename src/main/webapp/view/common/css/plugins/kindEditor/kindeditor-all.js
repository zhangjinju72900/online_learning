...
K.options = {
	...
	htmlTags : {
		...
		video : ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', '.width', '.height', 'align', 'allowscriptaccess', 'wmode', 'controls'],
...
KindEditor.plugin('clearhtml', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		html = K.formatHtml(html, {
			...
			video : ['src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', '.width', '.height', 'align', 'allowscriptaccess', 'controls'],
