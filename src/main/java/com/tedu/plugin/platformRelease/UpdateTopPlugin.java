...
import com.tedu.base.rule.function.CurrentTime;
 ...
 *
 */
@Service("updateTopPlugin")
public class UpdateTopPlugin implements ILogicPlugin {
	@Resource
	FormLogService formLogService;
	@Resource
	private FormMapper formMapper;
	private String sqlTemplate = "informations/UpdateTop";
	...
	public void doAfter(FormEngineRequest requestObj, FormModel formModel, Object beforeResult,
		...
		Long topBy = SessionUtils.getUserInfo().getEmpId();
