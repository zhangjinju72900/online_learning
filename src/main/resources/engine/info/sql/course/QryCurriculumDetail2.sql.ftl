...
LEFT JOIN (select cc1.curriculum_id, GROUP_CONCAT(course_id) as oneCourseId, GROUP_CONCAT(c1.`name`) as oneCourseName
 from t_curriculum_course cc1 LEFT JOIN t_course c1 on cc1.course_id = c1.id where curriculum_id = #{data.curriculumId} and cc1.grade_type = 1 GROUP BY cc1.curriculum_id)tab1 on c.id =  tab1.curriculum_id
LEFT JOIN (select cc1.curriculum_id, GROUP_CONCAT(course_id) as twoCourseId, GROUP_CONCAT(c1.`name`) as twoCourseName
 from t_curriculum_course cc1 LEFT JOIN t_course c1 on cc1.course_id = c1.id where curriculum_id = #{data.curriculumId} and cc1.grade_type = 2 GROUP BY cc1.curriculum_id)tab2 on c.id =  tab2.curriculum_id  
LEFT JOIN (select cc1.curriculum_id, GROUP_CONCAT(course_id) as threeCourseId, GROUP_CONCAT(c1.`name`) as threeCourseName
 from t_curriculum_course cc1 LEFT JOIN t_course c1 on cc1.course_id = c1.id where curriculum_id = #{data.curriculumId} and cc1.grade_type = 3 GROUP BY cc1.curriculum_id)tab3 on c.id =  tab3.curriculum_id 
LEFT JOIN (select cc1.curriculum_id, GROUP_CONCAT(course_id) as fourCourseId, GROUP_CONCAT(c1.`name`) as fourCourseName
 from t_curriculum_course cc1 LEFT JOIN t_course c1 on cc1.course_id = c1.id where curriculum_id = #{data.curriculumId} and cc1.grade_type = 4 GROUP BY cc1.curriculum_id)tab4 on c.id =  tab4.curriculum_id 
LEFT JOIN (select cc1.curriculum_id, GROUP_CONCAT(course_id) as fiveCourseId, GROUP_CONCAT(c1.`name`) as fiveCourseName
 from t_curriculum_course cc1 LEFT JOIN t_course c1 on cc1.course_id = c1.id where curriculum_id = #{data.curriculumId} and cc1.grade_type = 5 GROUP BY cc1.curriculum_id)tab5 on c.id =  tab5.curriculum_id  
where c.id = #{data.curriculumId}